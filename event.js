...
$(".button-solid23").click(function() {
    Swal.fire({
        ...
        html: '<div class="modalEventDetails"><p id="eventName">CLASH OF TITAN </p><p>GAMING</p><p id="date">Date:<p>Day 1 [11:30am to 12:30pm]</p><p>Day 2 [11:00am to 12:00pm, 11:15am to 12:30pm]  </p><p id="fee">Entry Fee: Rs 150/- per head</p><p id="location">Location:  PG Block Class 303</p><p>Student Coordinator:<br>Mr. Rohan D Karkera – 8921237465</p><p id="rules">Rules: <br />Participants: 4. On premises. Bring your own phone and earphones. No tablets allowed.  </p><a class="reglink" href="https://register.sditechelonmedha.com/">Register</a></div>',
        showCloseButton: true,
        icon: "",
        showCancelButton: false,
        showConfirmButton: false,
...
$(".button-solid24").click(function() {
    Swal.fire({
        ...
        html: '<div class="modalEventDetails"><p id="eventName">WOLF OF WALL STREET </p><p>IT MANAGER</p><p id="date">Date: <p>Day 1 [11:00am to 01:00pm]</p><p>Day 2 [09:00am to 11:00am] </p><p id="fee">Entry Fee: Rs 150/- per head</p><p id="location">Location: PG Block Class 204 & Seminar Hall </p><p>Student Coordinator:<br>Ms. Shobitha Shetty - 8123070487</p><p id="rules">Rules: <br />Participant: 1. Rules and Rounds will be given on the spot. The Contestant must carry a laptop.  </p><a class="reglink" href="https://register.sditechelonmedha.com/">Register</a></div>',
        showCloseButton: true,
        icon: "",
        showCancelButton: false,
        showConfirmButton: false,
...
$(".button-solid25").click(function() {
    Swal.fire({
        ...
        html: '<div class="modalEventDetails"><p id="eventName">THE OFFICE  </p><p>TECH-TALK</p><p id="date">Date: <p>Day 1 [01:00pm to 04:00pm]</p><p>Day 2 [09:00am to 11:00am, 01:00pm to 04:pm] </p><p id="fee">Entry Fee: Rs 150/- per head</p><p id="location">Location: PG Block Class 203 </p><p>Student Coordinator:<br>Ms. Swathi Y V – 7022415188</p><p id="rules">Rules: <br />Participant: 1. Rules and Round will be given on the spot. Round 1 and Round 2 . </p><a class="reglink" href="https://register.sditechelonmedha.com/">Register</a></div>',
        showCloseButton: true,
        icon: "",
        showCancelButton: false,
        showConfirmButton: false,
...
$(".button-solid26").click(function() {
    Swal.fire({
        ...
        html: '<div class="modalEventDetails"><p id="eventName">MIND HUNTER </p><p>QUIZ</p><p id="date">Date: <p>Day 1 [11:30am to 12:30pm, 02:00pm to 03:00pm]</p><p>Day 2 [09:00am to 11:00am, 11:15am to 12:15pm]  </p><p id="fee">Entry Fee: Rs 150/- per head</p><p id="location">Location: PG Block Class 301 </p><p>Student Coordinator:<br>Mr. Sukesh - 6361776570</p><p id="rules">Rules: <br />Participants: 2.  No conferring will be allowed between teams during the Quiz. No Gadgets allowed. </p><a class="reglink" href="https://register.sditechelonmedha.com/">Register</a></div>',
        showCloseButton: true,
        icon: "",
        showCancelButton: false,
        showConfirmButton: false,
...
$(".button-solid27").click(function() {
    Swal.fire({
        ...
        html: '<div class="modalEventDetails"><p id="eventName">FINDING NEMO </p><p>TREASURE HUNT</p><p id="date">Date: <p>Day 1 [11:00am to 04:00pm]</p><p>Day 2 [09:00am to 12:00pm]  </p><p id="fee">Entry Fee: Rs 150/- per head</p><p id="location">Location: PG Block Class 302</p><p>Student Coordinator:<br>Ms. Bhavanishesha S M - 7619269968</p><p id="rules">Rules: <br />Participants: 2. Round details will be given on the spot. Should not participate in any other event. </p><a class="reglink" href="https://register.sditechelonmedha.com/">Register</a></div>',
        showCloseButton: true,
        icon: "",
        showCancelButton: false,
        showConfirmButton: false,
...
$(".button-solid29").click(function() {
    Swal.fire({
        ...
        html: '<div class="modalEventDetails"><p id="eventName">PIXELS </p><p>PHOTOGRAPHY</p><p id="date">Date:<p> Day 1 [11:30am to 01:00pm, 02:00pm to 04:00pm]</p> </p><p id="fee">Entry Fee: Rs 150/- per head</p><p id="location"> Location: PG Block Class 202</p><p>Student Coordinator:<br>Mr. Deepak CH – 8971290622</p><p id="rules">Rules: <br />Participants: 1. Participants should get their own laptop, camera and headphone. </p><a class="reglink" href="https://register.sditechelonmedha.com/">Register</a></div>',
        showCloseButton: true,
        icon: "",
        showCancelButton: false,
        showConfirmButton: false,
...
$(".button-solid30").click(function() {
    Swal.fire({
        ...
        html: '<div class="modalEventDetails"><p id="eventName">THE REAL LIFE </p><p>VIDEOGRAPHY</p><p id="date">Date:<p> Day 1 [11:00am to 04:00pm]</p><p>Day 2 [09:00am to 01:00pm] </p></p><p id="fee">Entry Fee: Rs 150/- per head</p><p id="location">Location: PG Block Class 201</p><p>Student Coordinator:<br>Mr. Vivek - 6361356901</p><p id="rules">Rules: <br />Participants: 2. Cover all activities of Sambhram and Medha. Should not participate in any other event. Participants should get their own gadgets.  </p><a class="reglink" href="https://register.sditechelonmedha.com/">Register</a></div>',
        showCloseButton: true,
        icon: "",
        showCancelButton: false,
        showConfirmButton: false,
